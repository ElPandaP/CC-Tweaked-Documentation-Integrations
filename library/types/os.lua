...
--- ADVANCEDPERIPHERALS EVENTS
---| '"chat"' # Fires when a player sends a chat message (Chat Box attached). <hr/>[Official Documentation](https://docs.advanced-peripherals.de/latest/peripherals/chat_box/#chat)
---| '"playerClick"' # Fires when a player clicks the player detector. <hr/>[Official Documentation](https://docs.advanced-peripherals.de/latest/peripherals/player_detector/#playerclick)
---| '"playerJoin"' # Fires when a player joins the world/server. <hr/>[Official Documentation](https://docs.advanced-peripherals.de/latest/peripherals/player_detector/#playerjoin)
---| '"playerLeave"' # Fires when a player leaves the world/server. <hr/>[Official Documentation](https://docs.advanced-peripherals.de/latest/peripherals/player_detector/#playerleave)
---| '"playerChangedDimension"' # Fires when a player changes dimension. <hr/>[Official Documentation](https://docs.advanced-peripherals.de/latest/peripherals/player_detector/#playerchangeddimension)
--- ADVANCEDPERIPHERALS AE2 EVENTS
---| '"crafting"' # Fires when an ME Bridge crafting job starts or fails. <hr/>[Official Documentation](https://docs.advanced-peripherals.de/latest/peripherals/me_bridge/#crafting)